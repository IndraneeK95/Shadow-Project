from .Mobile_new import Mobile

class localuiautomatorlibrary(Mobile):
    """
    robotframework-localuiautomatorlibrary is an Android device testing library for Robot Framework.
